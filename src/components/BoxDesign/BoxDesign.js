  ...
  render() {
    ...
    return (
      <div className="box-selector edit-design flex-container">
        <TittleBox
          icon="far fa-object-ungroup icons-edit"
          tittle="Diseña"
              ...
              <li className="list-pallete">
                <label htmlFor="pallete-blue" className="label-color">
                  <input
                    ...
                    checked={this.props.dataCard.pallete === "1"}
                  />
                </label>
                <div className="pallet-box">
                  <div className="blue-dark-color" />
                  <div className="blue-midtone-color" />
                  <div className="blue-ligth-color" />
                </div>
              </li>
              <li className="list-pallete">
                <label htmlFor="pallete-red" className="label-color">
                  <input
                    ...
                    className="selection-input"
                    onChange={this.props.changePalette}
                    checked={this.props.dataCard.pallete === "2"}
                  />
                </label>
                <div className="pallet-box">
                  <div className="red-dark-color" />
                  <div className="red-midtone-color" />
                  <div className="red-ligth-color" />
                </div>
              </li>
              <li className="list-pallete">
                <label htmlFor="pallete-grey" className="label-color">
                  <input
                    ...
                    className="selection-input"
                    onChange={this.props.changePalette}
                    checked={this.props.dataCard.pallete === "3"}
                  />
                </label>
                <div className="pallet-box">
                  <div className="grey-dark-color" />
                  <div className="grey-ligth-color" />
                  <div className="grey-midtone-color" />
                </div>
              </li>
              <li className="list-pallete">
                ...
                <div className="pallet-box">
                  <div className="blue-gum-color" />
                  <div className="pink-midtone-color" />
                  <div className="pink-light-color" />
                </div>
              </li>
              <li className="list-pallete">
                ...
                <div className="pallet-box">
                  <div className="purple-midtone-color" />
                  <div className="purple-dark-color" />
                  <div className="purple-light-color" />
                </div>
              </li>
            </ul>
          </div>
              ...
              <li className="list-font">
                <label htmlFor="font-ubuntu" className="label-font">
                  <input
                    ...
                    name="select-font"
                    className="selection-input"
                    onChange={this.props.changeTypography}
